...
namespace Asphalt__Gradcoop
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        private void UpdatePrices(object sender, EventArgs eventArgs)
        {
            StartActivity(typeof(UpdatePricesActivity));
        }
        ...
        private void SetLocation(object sender, EventArgs eventArgs)
        {
            ...
            if (gpsCheck && LocationProxy.IsLocationAvailable())
            {
                ...
                {
                    text.Text = "";
                    Snackbar.Make(view, "Nije postignuta dovoljna preciznost probajte ponovo.", Snackbar.LengthShort).Show();
                }
            }
            else
            {
        ...
        private async void AskForLocationName() {
